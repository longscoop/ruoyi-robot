package com.robot.platform.framework.security.config;
...
import com.robot.platform.framework.security.core.context.TransmittableThreadLocalSecurityContextHolderStrategy;
import com.robot.platform.framework.security.core.filter.TokenAuthenticationFilter;
import com.robot.platform.framework.security.core.handler.AccessDeniedHandlerImpl;
import com.robot.platform.framework.security.core.handler.AuthenticationEntryPointImpl;
import com.robot.platform.framework.security.core.service.SecurityFrameworkService;
import com.robot.platform.framework.security.core.service.SecurityFrameworkServiceImpl;
 ...
 *
 * 注意，不能和 {@link RobotPlatformWebSecurityConfigurerAdapter} 用一个，原因是会导致初始化报错。
...
public class RobotPlatformSecurityAutoConfiguration {
