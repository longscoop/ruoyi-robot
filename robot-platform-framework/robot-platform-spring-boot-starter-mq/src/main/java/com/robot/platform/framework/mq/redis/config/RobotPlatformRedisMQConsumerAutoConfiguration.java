...
import com.robot.platform.framework.common.enums.DocumentEnum;
import com.robot.platform.framework.mq.redis.core.RedisMQTemplate;
import com.robot.platform.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.robot.platform.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.robot.platform.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.robot.platform.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class RobotPlatformRedisMQConsumerAutoConfiguration {
