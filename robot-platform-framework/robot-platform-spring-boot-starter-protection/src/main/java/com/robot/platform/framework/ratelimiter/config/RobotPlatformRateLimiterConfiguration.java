package com.robot.platform.framework.ratelimiter.config;

import com.robot.platform.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.robot.platform.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.robot.platform.framework.ratelimiter.core.keyresolver.impl.*;
...
public class RobotPlatformRateLimiterConfiguration {
