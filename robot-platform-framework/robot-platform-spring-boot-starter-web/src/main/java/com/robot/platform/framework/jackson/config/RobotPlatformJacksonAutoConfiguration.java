package com.robot.platform.framework.jackson.config;

import com.robot.platform.framework.common.util.json.JsonUtils;
import com.robot.platform.framework.common.util.json.databind.NumberSerializer;
import com.robot.platform.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.robot.platform.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class RobotPlatformJacksonAutoConfiguration {
