package com.robot.platform.framework.web.config;
...
import com.robot.platform.framework.web.core.filter.CacheRequestBodyFilter;
import com.robot.platform.framework.web.core.filter.DemoFilter;
import com.robot.platform.framework.web.core.handler.GlobalExceptionHandler;
import com.robot.platform.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class RobotPlatformWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "robot-platform.demo", havingValue = "true")
