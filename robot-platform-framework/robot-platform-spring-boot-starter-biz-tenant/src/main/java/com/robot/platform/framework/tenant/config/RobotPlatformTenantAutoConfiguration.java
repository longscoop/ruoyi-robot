package com.robot.platform.framework.tenant.config;
...
import com.robot.platform.framework.mybatis.core.util.MyBatisUtils;
import com.robot.platform.framework.redis.config.RobotPlatformCacheProperties;
...
import com.robot.platform.framework.tenant.core.aop.TenantIgnoreAspect;
import com.robot.platform.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.robot.platform.framework.tenant.core.job.TenantJobAspect;
import com.robot.platform.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.robot.platform.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.robot.platform.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.robot.platform.framework.tenant.core.redis.TenantRedisCacheManager;
import com.robot.platform.framework.tenant.core.security.TenantSecurityWebFilter;
import com.robot.platform.framework.tenant.core.service.TenantFrameworkService;
import com.robot.platform.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.robot.platform.framework.tenant.core.web.TenantContextWebFilter;
import com.robot.platform.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static com.robot.platform.framework.common.util.collection.CollectionUtils.convertList;

@AutoConfiguration
@ConditionalOnProperty(prefix = "robot-platform.tenant", value = "enable", matchIfMissing = true) // 允许使用 robot-platform.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class RobotPlatformTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.robot.platform.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     RobotPlatformCacheProperties robotPlatformCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(robotPlatformCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.robot.platform.framework.quartz.core.handler.JobHandler")
