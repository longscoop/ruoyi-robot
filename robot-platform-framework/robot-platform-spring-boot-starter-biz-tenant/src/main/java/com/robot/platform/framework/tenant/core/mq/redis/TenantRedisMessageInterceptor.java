package com.robot.platform.framework.tenant.core.mq.redis;

import cn.hutool.core.util.StrUtil;
import com.robot.platform.framework.mq.redis.core.interceptor.RedisMessageInterceptor;
import com.robot.platform.framework.mq.redis.core.message.AbstractRedisMessage;
import com.robot.platform.framework.tenant.core.context.TenantContextHolder;

import static com.robot.platform.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
