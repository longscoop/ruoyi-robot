 ...
 *      1）Spring Async：
 *          {@link com.robot.platform.framework.quartz.config.RobotPlatformAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 RobotPlatformSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.robot.platform.framework.tenant;
