...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.robot.platform";
    private static final String ARTIFACT_ID = "robot-platform";
    private static final String PACKAGE_NAME = "com.robot.platform";
