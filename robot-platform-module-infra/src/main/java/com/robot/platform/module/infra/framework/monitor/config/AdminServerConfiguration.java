package com.robot.platform.module.infra.framework.monitor.config;
 ...
 * 安全配置独立于 {@link com.robot.platform.framework.security.config.RobotPlatformWebSecurityConfigurerAdapter}，
