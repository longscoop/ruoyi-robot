package com.robot.platform.module.infra.controller.admin.codegen;
...
import com.robot.platform.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.robot.platform.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.robot.platform.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.robot.platform.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.robot.platform.module.infra.convert.codegen.CodegenConvert;
...
import com.robot.platform.module.infra.service.codegen.CodegenService;
...
import static com.robot.platform.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.robot.platform.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "robot-platform"),
