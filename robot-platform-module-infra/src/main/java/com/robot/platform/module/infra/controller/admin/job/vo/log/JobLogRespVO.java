package com.robot.platform.module.infra.controller.admin.job.vo.log;
...
import com.robot.platform.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "robot-platform")
