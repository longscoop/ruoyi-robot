package com.robot.platform.module.system.service.social;
...
import com.robot.platform.framework.common.util.cache.CacheUtils;
import com.robot.platform.framework.common.util.http.HttpUtils;
import com.robot.platform.framework.common.util.object.BeanUtils;
import com.robot.platform.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.robot.platform.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.robot.platform.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.robot.platform.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.robot.platform.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
import com.robot.platform.module.system.controller.admin.social.vo.client.SocialClientSaveReqVO;
import com.robot.platform.module.system.dal.dataobject.social.SocialClientDO;
import com.robot.platform.module.system.dal.mysql.social.SocialClientMapper;
import com.robot.platform.module.system.dal.redis.RedisKeyConstants;
import com.robot.platform.module.system.enums.social.SocialTypeEnum;
import com.robot.platform.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.robot.platform.framework.common.util.collection.MapUtils.findAndThen;
import static com.robot.platform.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.robot.platform.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.robot.platform.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${robot-platform.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${robot-platform.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应上游 pull request 230；来源见固定版本溯源记录。
