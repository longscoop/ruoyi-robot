...
import com.robot.platform.module.system.controller.admin.social.vo.user.SocialUserPageReqVO;
import com.robot.platform.module.system.dal.dataobject.social.SocialUserBindDO;
import com.robot.platform.module.system.dal.dataobject.social.SocialUserDO;
import com.robot.platform.module.system.dal.mysql.social.SocialUserBindMapper;
import com.robot.platform.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.robot.platform.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    public SocialUserDO authSocialUser(Integer socialType, Integer userType, String code, String state) {
        ...
        if (socialUser.getId() == null) {
            ...
            socialUser.clean(); // 避免 updateTime 不更新；相关上游 issue ID7FUL 见固定版本溯源记录。
