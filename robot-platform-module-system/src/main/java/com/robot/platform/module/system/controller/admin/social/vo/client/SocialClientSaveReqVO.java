package com.robot.platform.module.system.controller.admin.social.vo.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "robot-platform商城")
