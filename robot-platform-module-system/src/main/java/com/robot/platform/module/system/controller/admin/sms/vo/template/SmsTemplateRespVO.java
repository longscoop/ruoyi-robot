package com.robot.platform.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "robot-platform")
    @ExcelProperty("模板名称")
    private String name;
