        ...
        build: {
            ...
            rollupOptions: {
                output: {
                    ...
                    codeSplitting: {
                        groups: [
                            { name: 'echarts', test: /node_modules[\\/]echarts[\\/]/ }, // 将 echarts 单独打包，参考上游 issue IAB1SX 的讨论
                            { name: 'form-create', test: /node_modules[\\/]@form-create[\\/]element-ui[\\/]/ }, // 参考上游 issue 148 的讨论
